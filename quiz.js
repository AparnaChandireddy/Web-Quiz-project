...
function login() {
    ...
    // Here you can perform login validation or authentication
...
function register() {
    ...
    // Here you can perform validation for each field
    // For demonstration, let's just log the values to the console
    console.log('Register: Username - ' + username + ', Email - ' + email + ', Gender - ' + gender + ', Date of Birth - ' + dob + ', Password - ' + password);
}
